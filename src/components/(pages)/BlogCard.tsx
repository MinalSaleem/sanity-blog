...
export default function BlogCard({ post }: { post: Post }) {
  return (
    <section className="flex flex-col justify-between h-[630px] w-[402px] rounded group hover:scale-105 transition-transform ease-out duration-700 shadow-lg shadow-zinc-400">
      <div className="relative h-[360px] w-[400px] flex-1">
        <Image
